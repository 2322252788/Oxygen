...
public class MouseButton {
    ...
    public void renderMouseButton(int x, int y, int textColor) {
        ...
        if (KeyStrokes.mode.isCurrentMode("Low")) {
            ...
            this.fontS.drawString(cpsText, (float)(x + this.xOffset + 15) - cpsTextWidth / 2.0f, (float)(y + this.yOffset + 12), -16777216 + ((int)(255.0 * this.textBrightness) << 16) + ((int)(255.0 * this.textBrightness) << 8) + (int)(255.0 * this.textBrightness));
