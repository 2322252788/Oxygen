...
public class Key {
    ...
    public void renderKey(int x, int y, int textColor) {
        ...
        if (name.equals("SPACE")) {
        	...
        	Oxygen.INSTANCE.fontmanager.wqy18.drawString(name, (float)(x + this.xOffset + 20 / 2) - nameWidth / 2.0f, (float)(y + this.yOffset + 6), -16777216 + ((int)((double)red * this.textBrightness) << 16) + ((int)((double)green * this.textBrightness) << 8) + (int)((double)blue * this.textBrightness));
        }
    }
}
