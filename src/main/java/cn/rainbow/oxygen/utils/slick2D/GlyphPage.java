...
import cn.rainbow.oxygen.utils.slick2D.effect.Effect;
...
public class GlyphPage {
	...
	private final cn.rainbow.oxygen.utils.slick2D.Image pageImage;
	...
	public GlyphPage(UnicodeFont unicodeFont, int pageWidth, int pageHeight) throws SlickException {
		...
		pageImage = new cn.rainbow.oxygen.utils.slick2D.Image(pageWidth, pageHeight);
	}
