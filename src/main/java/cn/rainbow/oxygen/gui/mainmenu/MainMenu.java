...
public class MainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public OFontRenderer clientFont = Oxygen.INSTANCE.getFontmanager().wqy22;
    public OFontRenderer clientFont2 = Oxygen.INSTANCE.getFontmanager().wqy17;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Oxygen.INSTANCE.getFontmanager().wqy56.drawString(Oxygen.name.toUpperCase(), width / 2 - 53, height / 2 - 26, RenderUtil.reAlpha(ColorUtils.BLACK.c, 0.75f));
