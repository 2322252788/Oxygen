...
public class CFontRenderer extends OxygenFont {

	private final int[] colorCode = new int[32];

	public CFontRenderer(Font font, boolean antiAlias, boolean fractionalMetrics, boolean allChars) {
	...
	public float drawStringWithShadow(String text, double x2, double y2, int color) {
		float shadowWidth = this.drawString(text, x2 + 1, y2 + 1, color, true);
