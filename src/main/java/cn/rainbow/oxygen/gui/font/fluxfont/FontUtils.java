package cn.rainbow.oxygen.gui.font.fluxfont;
...
public class FontUtils {
    ...
    private Font getFont(String fontName, int fontType, int size) {
        ...
        try {
            InputStream ex = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("Oxygen/fonts/" + fontName)).getInputStream();
