...
public class ClickUI extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		Oxygen.INSTANCE.fontmanager.wqy30.drawString(Oxygen.name.toUpperCase(), this.x + 19, this.y, ClickGui.getMode().isCurrentMode("Dark") ? ColorUtils.WHITE.c :ColorUtils.AZURE.c);
		Oxygen.INSTANCE.fontmanager.wqy12.drawString(Oxygen.version, this.x + 34, this.y + 17, ClickGui.getMode().isCurrentMode("Dark") ? ColorUtils.WHITE.c :ColorUtils.GREY.c);
