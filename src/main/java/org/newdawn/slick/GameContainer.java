...
public abstract class GameContainer implements GUIContext {
	...
	protected boolean CopyLiteDeltas;
	...
	/**
	 * Indicate if we want to CopyLite deltas. This feature will report
	 * a delta based on the FPS not the time passed. This works well with 
	 * vsync.
	 * 
	 * @param CopyLiteDeltas True if we should report CopyLite deltas
	 */
	public void setSmoothDeltas(boolean CopyLiteDeltas) {
		this.CopyLiteDeltas = CopyLiteDeltas;
	}
