...
public class UIFlatButton extends GuiButton {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible) {
            ...
            Oxygen.INSTANCE.font.tahoma20.drawCenteredString(this.displayString, this.xPosition + this.width / 2, (int) ((float)this.yPosition + (float)(this.height - this.font.FONT_HEIGHT) / 2.0f) - 2, this.hovered ? -1 : -3487030);
            GL11.glPopAttrib();
            GL11.glPopMatrix();
        }
    }
