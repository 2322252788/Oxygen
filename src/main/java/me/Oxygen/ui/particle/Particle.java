...
public class Particle {
   ...
   public void drawScreen(int mouseX, int mouseY, int height) {
      ...
      RenderUtil.drawFilledCircle(this.x, this.y, this.radius, white);
      RenderUtil.drawLine(this.x, this.y - 1.8F, this.x, this.y + 1.8F, white);
      RenderUtil.drawLine(this.x - 0.2F, this.y - 1.8F, this.x, this.y - 1.8F, white);
      RenderUtil.drawLine(this.x - 1.8F, this.y - 0.8F, this.x + 1.8F, this.y + 0.8F, white);
      RenderUtil.drawLine(this.x - 1.8F, this.y + 0.8F, this.x + 1.8F, this.y - 0.8F, white);
   }
