...
public enum RenderUtil {
   ...
   public static int rainbow(int delay) {
      ...
      double var3;
      return Color.getHSBColor((float)((var3 = rainbow % 360.0D) / 360.0D), 0.5F, 1.0F).getRGB();
   }
   ...
   public static int rainbow(int delay, float slowspeed) {
      ...
      return Color.getHSBColor((float)((var4 = rainbow % 360.0D) / 360.0D), 0.5F, 1.0F).getRGB();
   }
   ...
   public static void drawFilledCircle(double x, double y, double r, int c, int id) {
      ...
      if(id == 1) {
         ...
         for(int i = 0; i <= 90; ++i) {
            double x2 = Math.sin((double)i * 3.141526D / 180.0D) * r;
            double y2 = Math.cos((double)i * 3.141526D / 180.0D) * r;
   ...
   public static int createShader(String shaderCode, int shaderType) throws Exception {
      ...
      ARBShaderObjects.glShaderSourceARB(shader1, (CharSequence)shaderCode);
   ...
   public static void setupFBO(net.minecraft.client.shader.Framebuffer fbo) {
	    org.lwjgl.opengl.EXTFramebufferObject.glDeleteRenderbuffersEXT((int)fbo.depthBuffer);
	    int stencil_depth_buffer_ID = org.lwjgl.opengl.EXTFramebufferObject.glGenRenderbuffersEXT();
	    org.lwjgl.opengl.EXTFramebufferObject.glBindRenderbufferEXT((int)36161, (int)stencil_depth_buffer_ID);
	    org.lwjgl.opengl.EXTFramebufferObject.glRenderbufferStorageEXT((int)36161, (int)34041, (int)net.minecraft.client.Minecraft.getMinecraft().displayWidth, (int)net.minecraft.client.Minecraft.getMinecraft().displayHeight);
	    org.lwjgl.opengl.EXTFramebufferObject.glFramebufferRenderbufferEXT((int)36160, (int)36128, (int)36161, (int)stencil_depth_buffer_ID);
	    org.lwjgl.opengl.EXTFramebufferObject.glFramebufferRenderbufferEXT((int)36160, (int)36096, (int)36161, (int)stencil_depth_buffer_ID);
	}
