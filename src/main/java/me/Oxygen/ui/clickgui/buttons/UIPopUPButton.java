package me.Oxygen.ui.clickgui.buttons;
...
import me.Oxygen.ui.clickgui.ClickMenu;
import me.Oxygen.utils.fontRenderer.UnicodeFontRenderer;
import me.Oxygen.utils.handler.ClientEventHandler;
...
public class UIPopUPButton {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        UnicodeFontRenderer font = Oxygen.INSTANCE.font.simpleton30;
        ...
        //Gui.circle(this.maxRadius + 10.0f, (float)sc.getScaledHeight() - this.maxRadius - 10.0f, this.maxRadius, FlatColors.ASPHALT.c);
        if (hovering) {
        ...
        if (this.openButton.name.equalsIgnoreCase("ClickGUI")) {
            float partialTicks = ((IMinecraft)Minecraft.getMinecraft()).getTimer().renderPartialTicks;
