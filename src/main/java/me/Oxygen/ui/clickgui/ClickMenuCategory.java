...
public class ClickMenuCategory {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        UnicodeFontRenderer font = Oxygen.INSTANCE.font.tahoma18;
        RenderUtils.R2DUtils.drawRoundedRect(this.x, this.y, this.x + this.width +0.5f, this.y + this.tab_height - 1, new Color(255, 255, 255).getRGB(), new Color(255, 255, 255).getRGB());
        ...
        font.drawString(name, (float)this.x + (this.width - font.getStringWidth(name)) / 5, this.y + (this.tab_height - font.FONT_HEIGHT) / 2, ClientUtil.reAlpha(Colors.BLACK.c, 1F));
        ...
        if (hoverArrow) {
            RenderUtil.drawImage(new ResourceLocation("Oxygen/icons/arrow-down.png"), this.x + this.width - 9, this.y + 7, 6, 6, new Color(0.7058824f, 0.7058824f, 0.7058824f));
        } else {
            RenderUtil.drawImage(new ResourceLocation("Oxygen/icons/arrow-down.png"), this.x + this.width - 9, this.y + 7, 6, 6);
        }
        GL11.glPopMatrix();
        RenderUtil.drawImage(new ResourceLocation("Oxygen/icons/panel.png"), this.x + 5, this.y + 6, 8, 8, new Color(255,255,255));
