...
public class UnicodeFontRenderer extends FontRenderer
{
    ...
    public UnicodeFontRenderer(final Font awtFont, final int fontPageStart, final int fontPageEnd) {
        ...
        this.widthMap = new HashMap<String, Float>();
        this.heightMap = new HashMap<String, Float>();
        (this.font = new UnicodeFont(awtFont)).addGlyphs(fontPageStart, fontPageEnd);
        this.font.getEffects().add(new ColorEffect(Color.WHITE));
        try {
            this.font.loadGlyphs();
        }
	...
	public int getStringWidth2(final String string) {
    ...
    public float getStringHeight2(final String string) {
