...
public class MoveUtil {
    ...
    public static void strafe() {
        strafe((float)Math.sqrt(mc.thePlayer.motionX * mc.thePlayer.motionX + mc.thePlayer.motionZ * mc.thePlayer.motionZ));
    }
	...
	public static void setSpeed(final double n) {
        Minecraft.getMinecraft().thePlayer.motionX = -(Math.sin(getDirection()) * n);
        Minecraft.getMinecraft().thePlayer.motionZ = Math.cos(getDirection()) * n;
    }
